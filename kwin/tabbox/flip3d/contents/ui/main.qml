...
KWin.TabBoxSwitcher {
    ...
    Window {
        ...
        PathView {
            ...
            highlightMoveDuration: Kirigami.Units.longDuration * (2 / Math.sqrt(visibleCount + 1))
            ...
            highlight: Item {} /*KSvg.FrameSvgItem {
    ...
    onVisibleChanged: {
        ...
        window.visible = visible && thumbnailView.count !== 0;
    }
}
